...
public partial class GameEntity {
    ...
    public void AddCharacter(CharacterState newState, Weapon newWeapon, bool newSelected, UnityEngine.Animator newAnimator, GameEntity newTarget) {
    ...
    public void ReplaceCharacter(CharacterState newState, Weapon newWeapon, bool newSelected, UnityEngine.Animator newAnimator, GameEntity newTarget) {
        var index = GameComponentsLookup.Character;
        var component = (CharacterComponent)CreateComponent(index, typeof(CharacterComponent));
        component.state = newState;
        component.weapon = newWeapon;
