...
public partial class GameContext {
    ...
    public GameEntity SetGlobals(UnityEngine.Transform newMainCameraTransform) {
        if (hasGlobals) {
        ...
        entity.AddGlobals(newMainCameraTransform);
        return entity;
    }

    public void ReplaceGlobals(UnityEngine.Transform newMainCameraTransform) {
        var entity = globalsEntity;
        if (entity == null) {
            entity = SetGlobals(newMainCameraTransform);
        } else {
            entity.ReplaceGlobals(newMainCameraTransform);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddGlobals(UnityEngine.Transform newMainCameraTransform) {
        var index = GameComponentsLookup.Globals;
        var component = (GlobalsComponent)CreateComponent(index, typeof(GlobalsComponent));
        component.mainCameraTransform = newMainCameraTransform;
