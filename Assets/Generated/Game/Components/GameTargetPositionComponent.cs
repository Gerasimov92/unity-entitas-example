...
public partial class GameEntity {
    ...
    public void AddTargetPosition(UnityEngine.Vector3 newValue, float newSpeed, float newStopDistance, bool newReached) {
        ...
        component.reached = newReached;
        AddComponent(index, component);
    }

    public void ReplaceTargetPosition(UnityEngine.Vector3 newValue, float newSpeed, float newStopDistance, bool newReached) {
        var index = GameComponentsLookup.TargetPosition;
        var component = (TargetPositionComponent)CreateComponent(index, typeof(TargetPositionComponent));
        component.value = newValue;
        component.speed = newSpeed;
